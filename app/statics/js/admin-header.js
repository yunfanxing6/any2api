      ...
      <header class="admin-header">
        <div class="admin-header-inner">
          <div class="admin-brand-wrap">
            <a href="/admin/dashboard" class="admin-brand-link">
              <span class="admin-brand">Any2API</span>
            </a>
            <a href="/admin/dashboard" class="admin-username" id="hd-user">Grok + Qwen</a>
          </div>
          <nav class="admin-nav">
            <a href="/admin/dashboard" class="admin-nav-link" data-nav="/admin/dashboard">运行总览</a>
            <a href="/admin/account" class="admin-nav-link" data-nav="/admin/account">Grok 账户</a>
            <a href="/admin/qwen-account" class="admin-nav-link" data-nav="/admin/qwen-account">Qwen 账户</a>
            <a href="/admin/config" class="admin-nav-link" data-nav="/admin/config" data-i18n="header.config">配置管理</a>
            <a href="/admin/keys" class="admin-nav-link" data-nav="/admin/keys">API Keys</a>
            <a href="/admin/test" class="admin-nav-link" data-nav="/admin/test">测试中心</a>
            <a href="/admin/diagnostics" class="admin-nav-link" data-nav="/admin/diagnostics">诊断</a>

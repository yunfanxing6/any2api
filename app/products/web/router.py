...
@router.get("/admin/qwen-account", include_in_schema=False)
...
async def admin_keys():
    return _serve_html("admin/keys.html")

@router.get("/admin/test", include_in_schema=False)
async def admin_test():
    return _serve_html("admin/test.html")

@router.get("/admin/diagnostics", include_in_schema=False)
async def admin_diagnostics():
    return _serve_html("admin/diagnostics.html")
